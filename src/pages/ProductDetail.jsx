...
function CartDrawer({ open, onClose, cart, cartCount, cartTotal, onDecrease, onIncrease, onRemove, onClear }) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex justify-end">
      ...
      <aside className="relative flex h-full w-full max-w-[340px] flex-col border-l border-white/[0.07]"
  ...
  return (
    <>
      ...
      <div className="min-h-screen" style={{ background: "#0e0c09" }}>
        ...
        {toast && (
          <div className="pointer-events-none fixed left-1/2 z-[80] -translate-x-1/2 rounded-full bg-[#c8922a] px-5 py-2.5 text-[12px] font-semibold text-[#0e0c09] shadow-[0_16px_48px_rgba(0,0,0,0.5)]"
